...
public class Scene4 : MonoBehaviour
{
    ...
    IEnumerator EventTwo()
    {
        ...
        textArea.text = "";
        string sentence = "Edgar! You shall be the next king!";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventThree()
    {
        ...
        textArea.text = "";
        string sentence = "I am honoured father! I shall carry on your will and bring our kingdom prosperity.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventFour()
    {
        ...
        yield return new WaitForSeconds(2);
        textBox.SetActive(true);
        string sentence = "Congratulations Edgar! You have my approval!";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventFive()
    {
        ...
        yield return new WaitForSeconds(2);
        textBox.SetActive(true);
        string sentence = "Congratulations. A wise decision.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventSeven()
    {
        ...
        yield return new WaitForSeconds(2);
        textBox.SetActive(true);
        string sentence = "Congratulations Edgar. I too acknowlegde you as the new king.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventEight()
    {
        ...
        yield return new WaitForSeconds(2);
        textBox.SetActive(true);
        string sentence = "Congratulations Brother Edgar. I am glad everyone accepts you as the king.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventNine()
    {
        ...
        textBox.SetActive(true);
        string sentence = "Hahaha, looks like you had already won them over!";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventTen()
    {
        ...
        charName.text = "Prince Edgar";
        textArea.text = "";
        string sentence = "(Smiles) All I did was pulling some strings! Shall we get going then? We have a feast to prepare for.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
    ...
    IEnumerator EventEleven()
    {
        ...
        yield return new WaitForSeconds(2);
        textBox.SetActive(true);
        string sentence = "Hahaha.. Yes surely. King Edgar.";
        StartCoroutine(Type(sentence));
        yield return new WaitUntil(() => currText == sentence);
        eventCount++;
        continueButton.SetActive(true);
